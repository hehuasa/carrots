/*
* Changed by Frank on 2016-8-31.
*/
//公司编辑常量组

carrotsBackstage.constant('con', {
  	//发布时间
  	updateAt:[
	  {type:null,name:'不限'},
	  {type:0,name:'今天'},
...
//候选人列表常量
	...
	//技能图例
	skillLgend:[
		{type:1,name:'未了解过（级别：1）'},
		{type:2,name:'了解，工作中未使用过（级别：2）'},
		{type:3,name:'工作中使用过，不清楚原理（级别：3）'},
		{type:4,name:'工作中使用过，了解原理（级别：4）'},
		{type:5,name:'了解原理，在工作中改进（级别：5）'},
		{type:6,name:'自己编写的框架（级别：6）'}
	],
	//推荐列表的通过状态
	statusLast:[
		{type:0,name:'尚未面试'},
...
// 公司行业多选数据
	companyIndustryGroup:[
		{industry: 0,name: '移动互联网'},// ticked: true
		{name: '电子商务',industry: 1},
		{name: '企业服务 ',industry: '2'},
		{name: 'O2O',industry: '3'},
		{name: '教育',industry: '4'},
		{name: '金融',industry: '5'},
		{name: '游戏',industry: '6'}
...
carrotsBackstage.constant('PROVINCE', [
...
carrotsBackstage.constant('CITY', [
...
carrotsBackstage.constant('COUNTY', [
